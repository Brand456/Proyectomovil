      ...
      TableRow(
        children: [
          _crearBotonRedondeado(Colors.blue, Icons.border_all,
              'Gestionar tesis', context, 'home'),
          _crearBotonRedondeado(Colors.purpleAccent, Icons.directions_bus,
              'Gestionar actividad', context, 'homechatver'),
        ],
      ),
      TableRow(
        children: [
          _crearBotonRedondeado(
              Colors.pinkAccent, Icons.shop, 'Avisos', context, 'homeavis'),
          _crearBotonRedondeado(Colors.orange, Icons.insert_drive_file, 'Chat',
              context, 'homechat'),
        ],
      ),
    ],
